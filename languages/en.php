<?php
	$lang = array(
        ...
        //About me
        "about-title" => "IT consultant specialized in cybersecurity and sysadmin.",
        "about-subtitle" => "Technologist and one hundred more things. I try to learn continuously and get involved in new projects.",
        "about-bio-1" => "<b>Hey, nice to meet you!</b> This is Manuel, a youth with strong interest on learn new things day-a-day. BSc in Computer Science Engineering by the <a href='http://www.usc.gal/'>Universidade de Santiago de Compostela</a> and MSc in Information and Communication Technologies Security by the <a href='https://www.uoc.edu/'>Universitat Oberta de Catalunya</a>, the <a href='https://www.uab.cat/'>Universitat Autònoma de Barcelona</a> and the <a href='https://www.urv.cat/'>Universitat Rovira i Virgili</a>. Besides technology, I am also interested in reading <i class='em em-open_book'></i>, writing <i class='em em-writing_hand'></i>, participating at technological associations <i class='fas fa-terminal'></i>, listening to music <i class='em em-headphones'></i>, learning languages and linguistics <i class='em em-tongue'></i> or playing videogames <i class='em em-video_game'></i>. A bit of everything, while creativity and imagination get involved.",
