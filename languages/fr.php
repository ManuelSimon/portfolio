...
$lang = array(
    ...
    //About me
    "about-title" => "Consultant informatique spécialisé en cybersécurité et systèmes.",
    ...
    "about-bio-1" => "<b>Salut, enchanté !</b> Je suis Manuel, un jeune qui s'intéresse chaque jour à apprendre des nouvelles choses. Diplômé en Ingénierie Informatique par l'<a href='http://www.usc.gal/'>Universidade de Santiago de Compostela</a> et Master en Sécurité des Technologies de l'information et de la communication par l'<a href='https://www.uoc.edu/'>Universitat Oberta de Catalunya</a>, l'<a href='https://www.uab.cat/'>Universitat Autònoma de Barcelona</a> et l'<a href='https://www.urv.cat/'>Universitat Rovira i Virgili</a>. En plus de l'informatique, j'aime lire <i class='em em-open_book'></i>, écrire <i class='em em-writing_hand'></i>, participer à des associations technologiques <i class='fas fa-terminal'></i>, écouter de la musique <i class='em em-headphones'></i>, apprendre les langues et la linguistique <i class='em em-tongue'></i> ou jouer à des jeux vidéo <i class='em em-video_game'></i>. Un peu de tout, tant que la créativité et l'imagination sont impliquées.",
    ...
    "cv-pdf-link" => "/docs/CVmsnovoaFR.pdf",
